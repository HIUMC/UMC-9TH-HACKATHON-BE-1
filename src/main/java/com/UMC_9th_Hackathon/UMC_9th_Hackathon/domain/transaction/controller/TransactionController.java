...
//    @PostMapping(consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
    ...
    public ApiResponse<Long> createTransaction(
            @RequestBody @Valid TransactionReqDTO.TransactionCreateRequest request) { // @RequestPart 대신 @RequestBody

        Long id = transactionService.saveTransaction(request); // image 파라미터 삭제
